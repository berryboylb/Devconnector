...
const AddEducation = ({ addEducation }) => {
  ...
  return (
      ...
      <p className="lead">
        <FontAwesomeIcon icon={faCodeBranch} /> Add any school or bootcamp that you've attended
      </p>
      ...
      <form className="form" onSubmit={onSubmit}>
        ...
        <div className="form-group">
          <h4>To Date</h4>
          {/* the disabled prop is used to check if current is true then to should not work */}
